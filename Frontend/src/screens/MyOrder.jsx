...
export default function MyOrder() {
    ...
    const fetchMyOrder = async () => {
        ...
        await fetch("https://foodapplicationbackend.onrender.com/api/myOrderData", {
            // credentials: 'include',
                                                    ...
                                                    {arrayData.Order_date ? <div className='m-auto mt-5'>
                                                        ...
                                                        <div className='col-12 col-md-6 col-lg-3' >
                                                            <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px" }}>
                                                                <img src={arrayData.img} className="card-img-top" alt="..." style={{ height: "auto", objectFit: "fill" }} />
                                                                <div className="card-body">
                                                                    <h5 className="card-title">{arrayData.name}</h5>
                                                                    <div className='container w-100 p-0' style={{ height: "138px" }}>
                                                                        <p className='m-1'>{arrayData.qty}</p>
                                                                        <p className='m-1'>{arrayData.size}</p>
                                                                        <p className='m-1'>{data}</p>
                                                                        <div style={{color:'greenyellow'}} className=' d-inline ms-2 h-100 w-20 fs-5' >
                                                                            ₹{arrayData.price}/-
                                                                        </div>
                                                                    </div>
                                                                </div>
